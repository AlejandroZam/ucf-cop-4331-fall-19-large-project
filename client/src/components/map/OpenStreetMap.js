...
import ContactModal from '../menuModal/MenuModal';
...
class OpenStreetMap extends Component {
  ...
  // Base point for center of map (UCF)
  state = {
    lat: 28.602616,
    lng: -81.200092,
    zoom: 16,
  ...
  render() 
  {
    ...
    {
        return (
          <Map style={{height: "100%", width:"96%", float:"left", zIndex:"0"}} center={position} zoom={this.state.zoom}>
          <TileLayer
    ...
    // NO CHANGES SHOULD BE PUT HERE AS THIS SHOULDN'T REALLY BE DISPLAYED FOR MORE THAN A SECOND
    return (
